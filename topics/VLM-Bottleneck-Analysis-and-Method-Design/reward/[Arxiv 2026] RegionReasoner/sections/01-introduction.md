...
- **Baseline Gap**: VisionReasoer (单轮，无显式引用，奖励不覆盖推理轨迹) vs SegLLM (多轮但无思考过程、无 RL)
- **方案**: RegionReasoer = reference-grounded thinking + global--local consistency reward + RegionDial-Bench

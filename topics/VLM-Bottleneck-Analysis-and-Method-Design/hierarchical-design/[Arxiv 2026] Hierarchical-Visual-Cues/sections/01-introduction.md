...
> - Heima：visual as data to compress → reasoning driven by TEXT CoT → visual not in reasoning loop
> - HIVE：visual as driver of reasoning → hierarchical cues injected INTO recurrent blocks → visual IS the reasoning signal

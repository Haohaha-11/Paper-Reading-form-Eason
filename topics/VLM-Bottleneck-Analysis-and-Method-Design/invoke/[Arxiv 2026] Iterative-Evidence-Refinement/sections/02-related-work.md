...
> 3. **像素空间探索** (Pixel Reasoer, Perception-R1): 不再局限于预定义工具，鼓励模型在像素空间自由探索。问题是计算开销大，且探索效率低。
...
> | 可学习潜视觉令牌 | Latent Visual Reasoing, DeepSketcher, Machine Mental Imagery | 引入**新的可学习 token**，在潜空间操作视觉表示 | 需要大量训练对齐，潜令牌与文本空间不天然兼容 |

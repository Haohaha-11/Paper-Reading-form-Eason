...
| 论文 | 子类别 | 方法特点 |
|------|--------|----------|
| [Q-Zoom](./encoding/%5BArxiv 2025%5D Q-Zoom/) | encoding | Query-aware 自适应视觉感知，根据问题动态调整图像编码粒度。 |
| [CARES](./encoding/%5BArxiv 2025%5D CARES/) | encoding | 上下文感知的分辨率选择器，让 VLM 自适应选择最优图像分辨率。 |
| [iGVLM](./encoding/%5BArxiv 2026%5D iGVLM/) | encoding | 动态指令引导视觉编码，实现问题感知的多模态理解。 |
| [Perceptual-Bandwidth-Bottleneck](./encoding/%5BArxiv 2026%5D Perceptual-Bandwidth-Bottleneck/) | encoding | 感知带宽瓶颈分析，提出主动视觉推理作为 sequential experimental design。 |
...
| 论文 | 子类别 | 方法特点 |
|------|--------|----------|
| [Hierarchical-Visual-Cues](./hierarchical-design/%5BArxiv 2026%5D Hierarchical-Visual-Cues/) | hierarchical | 层级化视觉线索注入，多粒度视觉信息逐步融合到推理过程。 |
...
| 论文 | 子类别 | 方法特点 |
|------|--------|----------|
| [Iterative-Evidence-Refinement](./invoke/%5BArxiv 2026%5D Iterative-Evidence-Refinement/) | invoke | 迭代证据精炼，多轮调用视觉信息逐步增强推理质量。 |
| [Thinking-with-Visual-Grounding](./invoke/%5BArxiv 2026%5D Thinking-with-Visual-Grounding/) | invoke | 视觉 grounding 驱动的思维过程，让推理步骤与图像区域直接关联。 |
...
| 论文 | 子类别 | 方法特点 |
|------|--------|----------|
| [More-Images-More-Problems](./bottleneck-analysis/%5BArxiv 2026%5D More-Images-More-Problems/) | bottleneck | 受控分析 VLM 在多图场景下的 failure mode——更多图像是否带来更多问题？ |
...
| 论文 | 子类别 | 方法特点 |
|------|--------|----------|
| [Dual-Mechanisms-Spatial-Binding](./multi-image/%5BArxiv 2026%5D Dual-Mechanisms-Spatial-Binding/) | multi-image | VLM 中空间变量绑定的双重机制。 |
...
| 论文 | 子类别 | 方法特点 |
|------|--------|----------|
| [MedSynapse-V-v2](./medical/%5BArxiv 2026%5D MedSynapse-V-v2/) | medical | 视觉感知与临床直觉的 latent memory 桥接，latent diagnostic memory evolution。 |
